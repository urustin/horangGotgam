...
// Product types
// Runtime config via public/env.js (generated by scripts/build-env.sh).
// If env.js is missing, malformed, or productType is invalid → fallback "gotgam".
const _runtimeCfg = (typeof window !== "undefined" && window.__HORANG_CONFIG__) || {};
const _allowedTypes = ["gotgam", "durup"];
export const PRODUCT_TYPES = _allowedTypes.includes(_runtimeCfg.productType)
    ? _runtimeCfg.productType
    : "gotgam";
